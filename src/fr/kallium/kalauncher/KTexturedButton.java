...
public class KTexturedButton extends AbstractButton {
    ...
    public KTexturedButton(BufferedImage texture) {
        this(texture, (BufferedImage)null, (BufferedImage)null);
    }

    public KTexturedButton(BufferedImage texture, BufferedImage textureHover) {
        this(texture, textureHover, (BufferedImage)null);

    }

    public KTexturedButton(BufferedImage texture, BufferedImage textureHover, BufferedImage textureDisabled) {
        if (texture == null) {
    ...
    public void idIsValid(boolean valid){
